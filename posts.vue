		...
		<div class="site_container inside_page_content page_content">
            ...
            <div class="post_container" v-if="posts" v-for="post in posts">
                ...
                <div class="post_content">
			        ...
			        <social-sharing :url="$root.shareURL('posts',post.slug)" :title="post.title" :description="post.body" :quote="_.truncate(post.description, {'length': 99})" :twitter-user="$root.twitter_user" :media="post.image_url" inline-template >
						<div class="post_list_share">
							<div class="social_share">
								<network network="facebook">
									<i class="fa fa-facebook social_icons" aria-hidden="true"></i>
