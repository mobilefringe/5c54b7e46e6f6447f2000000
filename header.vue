    						...
    						<nav id="mobile_nav" v-show="show_mobile_menu">
    							<ul>
    								<div class="mobile_menu_site_logo">
    									<router-link to="/"><img //codecloud.cdn.speedyrails.net/sites/5c54b7e46e6f6447f2000000/image/png/1549474760240/new_sudbury_transparent copy.pngsrc="property_logo" :alt="property.name +' Mobile Logo'"/></router-link>
    								</div>
