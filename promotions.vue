					...
					<div class="row event_container" v-if="showMore > index" v-for="(promo,index) in promos">
						...
						<div class="col-sm-6 col-md-8 event_dets_container">
							...
							<div class="text-right  col-sm-6" v-if="promo" style="padding:0">
								...
								<social-sharing :url="$root.shareURL('promotions',promo.slug)" :title="promo.title" :description="promo.body" :quote="_.truncate(promo.description, {'length': 99})" twitter-user="BCCstyle" :media="promo.image_url" inline-template >
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= webDate) {
                            ...
                            if (value.store  && _.includes(value.store.store_front_url_abs, 'missing')) {
                                ...
                                value.store = {};
                                value.store.store_front_url_abs = this.property.default_logo_url;
                            }
