            		...
            		<div class="row event_container" v-if="showMore > index" v-for="(promo,index) in promos">				
						...
						<div class="col-sm-6 col-md-8 event_dets_container">
							...
							<div class="text-right  col-sm-6" v-if="promo" style="padding:0">
								...
								<social-sharing :url="$root.shareURL('events',promo.slug)" :title="promo.title" :description="promo.body" :quote="_.truncate(promo.description, {'length': 99})" twitter-user="BCCstyle" :media="promo.image_url" inline-template >
